...
public class aboutPreferences extends Preference
    ...
    public aboutPreferences(Context context) {
        super(context);
    }

    public aboutPreferences(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public aboutPreferences(Context context, AttributeSet attrs, int defStyle) {
